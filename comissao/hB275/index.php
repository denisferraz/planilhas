...
<head>
    ...
    <title>Comissões Reservas</title>
</head>
<body>
<h1><?php echo $_SESSION['hotel_name']; ?> - Comissões Reservas</h1>
...
<span class="card-group-left"><a href="../../painel.php"><button>Voltar</button></a></span>
    ...
    <div class="container">
        ...
        <label><b>Arrivals + Cancelations + Invoices</b></label>
        <input type="file" name="csvFile[]" accept=".csv" multiple required><br><br>
        <label><b>Planilha de Comissões</b></label>
        <input type="file" name="excelFile" accept=".xlsx"><br>
