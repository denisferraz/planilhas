...
<span class="card-group-left"><a href="../../painel.php"><button>Voltar</button></a></span>
    ...
    <div class="container">
        ...
        <label><b>Salve os relatorios como: XLS Relatório Arquivo</b><br><br>
            <b>[1]</b> - Recepção->Check-ins [ <b>M:\Users\Vega\Downloads\checkin.xls</b> ]<br>
            <b>[2]</b> - Recepção->Hospedes na Casa [ <b>M:\Users\Vega\Downloads\inhouse.xls</b> ]<br>
            <b>[3]</b> - Governança->Formulario de Discrepancias [ <b>M:\Users\Vega\Downloads\quartos.xls</b> ]<br>
            <b>[4]</b> - Caixa->Saldo Contas [ <b>M:\Users\Vega\Downloads\saldos.xls</b> ]
        </label>
        <br><input type="file" name="xlsFile[]" accept=".xls" multiple required><br>
