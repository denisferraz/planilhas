...
<div class="appointment">
    <span class="name">[ <?php  echo $room_number?> - <?php echo $room_type ?> ]</span> <span class="time"><?php echo $guest_name ?> - <?php echo date('d/m/Y') ?> a <?php echo date('d/m/Y', strtotime("+$noites days")); ?> | <span class="name">Hospedes [ <?php echo $adultos ?> ] | Diária [ R$<?php echo $room_ratecode.' - '.$room_msg ?> ]</span>
