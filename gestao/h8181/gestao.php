...
<span class="name">DBC</span> (<span class="time"><?php echo $quantidades['DBC'] ?>/<?php echo $roomTypeQuantidades['DBC'] ?></span>) - <span class="name">DSC</span> (<span class="time"><?php echo $quantidades['DSC'] ?>/<?php echo $roomTypeQuantidades['DSC'] ?></span>) - <span class="name">TWC</span> (<span class="time"><?php echo $quantidades['TWC'] ?>/<?php echo $roomTypeQuantidades['TWC'] ?></span>) - <span class="name">AZH</span> (<span class="time"><?php echo $quantidades['AZH'] ?>/<?php echo $roomTypeQuantidades['AZH'] ?></span>)
</div>
...
<span class="name">DBC</span> (<span class="time"><?php echo $roomTotalQuantidades['DBC']-$roomInhouseQuantidades['DBC']-$quantidades['DBC'] ?></span>) - <span class="name">DSC</span> (<span class="time"><?php echo $roomTotalQuantidades['DSC']-$roomInhouseQuantidades['DSC']-$quantidades['DSC'] ?></span>) - <span class="name">TWC</span> (<span class="time"><?php echo $roomTotalQuantidades['TWC']-$roomInhouseQuantidades['TWC']-$quantidades['TWC'] ?></span>) - <span class="name">AZH</span> (<span class="time"><?php echo $roomTotalQuantidades['AZH']-$roomInhouseQuantidades['AZH']-$quantidades['AZH'] ?></span>)
</div>
