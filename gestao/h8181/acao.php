...
<div class="appointment">
<label>Reserva: <b><?php echo $guest_name ?></b> [ <b><?php echo $room_number ?></b> - <?php echo $room_ratecode ?> ] - Periodo: <b><?php echo date('d/m/Y') ?></b> a <b><?php echo date('d/m/Y', strtotime("+{$noites} days")) ?></b></label>  
</div>
<div class="appointment">
