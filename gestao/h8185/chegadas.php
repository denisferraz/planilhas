...
$query_chegadas = $conexao->prepare("SELECT * FROM $dir"."_excel_gestaorecepcao_arrivals WHERE id > 0 AND alteracao = 'Pendente' ORDER BY room_number DESC");
...
<!-- Chegadas -->
<fieldset>
<legend> (<?php echo $chegadas_qtd ?>) Chegadas </legend>
