...
<span class="card-group-left"><a href="../../painel.php"><button>Voltar</button></a></span>
    ...
    <div class="container">
        <h1>Anexe o Relatorio para Gerar o Plano de Quartos Digital</h1><br>
        ...
        <input type="number" name="camareiras" min="1" max="100" value="10" required><br><br>
        <center>
        <label><b>Salve o relatorio como: XLS Relatório Arquivo</b><br><br>
        <b>[1]</b> - Governança->Formulário de Discrepancia [ <b>M:\Users\Vega\Downloads\quartos.xls</b> ]<br>
        <br>
        </label>
        </center>
