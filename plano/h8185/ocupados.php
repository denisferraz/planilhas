...
$dados_ocupado = $_SESSION['dados_roomstatus'];

$dados_roomstatus = array_filter($dados_ocupado, function($item) {
    return $item['room_status_1'] == "Occupied" && $item['room_stay_status'] != "Pending depart";
});
