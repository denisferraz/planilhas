...
$activeWorksheet->setCellValue('G21', $forecast_occ_1);
...
$activeWorksheet->setCellValue('H21', $forecast_occ_2);
...
$activeWorksheet->setCellValue('I21', $forecast_occ_3);
...
//Assinatura
$activeWorksheet->setCellValue('C27', $_SESSION['name'].' | '.$data_quando.'h');
...
//$activeWorksheet->setCellValue('G27', '');
//$activeWorksheet->mergeCells('G27:J27');
//$activeWorksheet->setCellValue('G28', 'Assinatura Digital N + 1');
//$activeWorksheet->mergeCells('G28:J28');
...
//$activeWorksheet->getStyle('G27:J28')->applyFromArray($styleArray_outside_borders);
...
//$activeWorksheet->mergeCells('G'.($linha_excel + 10).':I'.($linha_excel + 10));
//$activeWorksheet->setCellValue('G'.($linha_excel + 11), 'Assinatura Digital N + 1');
//$activeWorksheet->mergeCells('G'.($linha_excel + 11).':I'.($linha_excel + 11));
...
//$activeWorksheet->getStyle('G'.($linha_excel + 10).':I'.($linha_excel + 11))->applyFromArray($styleArray_outside_borders);
...
$activeWorksheet->setCellValue('I14',  number_format(${"uhs_ocupadas_$mes_atual"} * $dia_atual, 0, ',', '.'));
...
$activeWorksheet->setCellValue('I17',  number_format(${"uhs_ocupadas_$mes_atual"} * $dia_atual, 0, ',', '.'));
