...
<legend>Caixa</legend>
<table>
<th colspan="7">Recebimentos e Pagamentos [Conferidos]</th>
<tr>
    ...
    <td align="center" colspan="2"><div class="botao-topo-chegadas"><a href="javascript:void(0)" onclick='window.open("caixa_conf.php","iframe")'><button>Conferidos</button></a></div></td>
</tr>
...
<input type="hidden" name="id_job" value="caixa_conf">
