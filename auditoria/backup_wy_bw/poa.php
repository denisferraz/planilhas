...
<tr class="darkgrey">
    <td><b>Total Uhs</b></td>
    <td><input class="input-field-auditoria" type="number" name="total_uhs_fev" value="<?php echo $total_uhs_fev ?>" required></td>
</tr>
<tr>
    <td><b>Quartos Ocupados</b></td>
    <td><input class="input-field-auditoria" type="number" name="uhs_ocupadas_fev" value="<?php echo $uhs_ocupadas_fev ?>" required></td>
</tr>
<tr class="darkgrey">
    <td><b>Diária Média</b></td>
    <td><input class="input-field-auditoria" type="number" name="dm_fev" value="<?php echo $dm_fev ?>" required></td>
</tr>
<tr>
    <td><b>Receita Hospedagem</b></td>
    <td><input class="input-field-auditoria" type="number" name="total_hospedagem_fev" value="<?php echo $total_hospedagem_fev ?>" required></td>
</tr>
<tr><td style="background-color: black" colspan="2"></td></tr>
</table>
</td>
...
<tr class="darkgrey">
    <td><b>Total Uhs</b></td>
    <td><input class="input-field-auditoria" type="number" name="total_uhs_abr" value="<?php echo $total_uhs_abr ?>" required></td>
</tr>
<tr>
    <td><b>Quartos Ocupados</b></td>
    <td><input class="input-field-auditoria" type="number" name="uhs_ocupadas_abr" value="<?php echo $uhs_ocupadas_abr ?>" required></td>
</tr>
<tr class="darkgrey">
    <td><b>Diária Média</b></td>
    <td><input class="input-field-auditoria" type="number" name="dm_abr" value="<?php echo $dm_abr ?>" required></td>
</tr>
<tr>
    <td><b>Receita Hospedagem</b></td>
    <td><input class="input-field-auditoria" type="number" name="total_hospedagem_abr" value="<?php echo $total_hospedagem_abr ?>" required></td>
</tr>
<tr><td style="background-color: black" colspan="2"></td></tr>
</table>
</td>
...
<tr class="darkgrey">
    <td><b>Total Uhs</b></td>
    <td><input class="input-field-auditoria" type="number" name="total_uhs_set" value="<?php echo $total_uhs_set ?>" required></td>
</tr>
<tr>
    <td><b>Quartos Ocupados</b></td>
    <td><input class="input-field-auditoria" type="number" name="uhs_ocupadas_set" value="<?php echo $uhs_ocupadas_set ?>" required></td>
</tr>
<tr class="darkgrey">
    <td><b>Diária Média</b></td>
    <td><input class="input-field-auditoria" type="number" name="dm_set" value="<?php echo $dm_set ?>" required></td>
</tr>
<tr>
    <td><b>Receita Hospedagem</b></td>
    <td><input class="input-field-auditoria" type="number" name="total_hospedagem_set" value="<?php echo $total_hospedagem_set ?>" required></td>
</tr>
<tr><td style="background-color: black" colspan="2"></td></tr>
</table>
</td>
...
<tr class="darkgrey">
    <td><b>Total Uhs</b></td>
    <td><input class="input-field-auditoria" type="number" name="total_uhs_out" value="<?php echo $total_uhs_out ?>" required></td>
</tr>
<tr>
    <td><b>Quartos Ocupados</b></td>
    <td><input class="input-field-auditoria" type="number" name="uhs_ocupadas_out" value="<?php echo $uhs_ocupadas_out ?>" required></td>
</tr>
<tr class="darkgrey">
    <td><b>Diária Média</b></td>
    <td><input class="input-field-auditoria" type="number" name="dm_out" value="<?php echo $dm_out ?>" required></td>
</tr>
<tr>
    <td><b>Receita Hospedagem</b></td>
    <td><input class="input-field-auditoria" type="number" name="total_hospedagem_out" value="<?php echo $total_hospedagem_out ?>" required></td>
</tr>
<tr><td style="background-color: black" colspan="2"></td></tr>
</table>
</td>
...
<tr class="darkgrey">
    <td><b>Total Uhs</b></td>
    <td><input class="input-field-auditoria" type="number" name="total_uhs_dez" value="<?php echo $total_uhs_dez ?>" required></td>
</tr>
<tr>
    <td><b>Quartos Ocupados</b></td>
    <td><input class="input-field-auditoria" type="number" name="uhs_ocupadas_dez" value="<?php echo $uhs_ocupadas_dez ?>" required></td>
</tr>
<tr class="darkgrey">
    <td><b>Diária Média</b></td>
    <td><input class="input-field-auditoria" type="number" name="dm_dez" value="<?php echo $dm_dez ?>" required></td>
</tr>
<tr>
    <td><b>Receita Hospedagem</b></td>
    <td><input class="input-field-auditoria" type="number" name="total_hospedagem_dez" value="<?php echo $total_hospedagem_dez ?>" required></td>
</tr>
<tr><td style="background-color: black" colspan="2"></td></tr>
</table>
</td>
