...
$_SESSION['dados_gerencial'] = $diaria_dia.';'.$diaria_mes.';'.$restaurante_dia.';'.$restaurante_mes.';'.$lavanderia_dia.';'.$lavanderia_mes.';'.$taxaiss_dia.';'.$taxaiss_mes.';'.$eventos_dia.';'.$eventos_mes.';'.$diversos_dia.';'.$diversos_mes;
$_SESSION['dados_gerencial_occ'] = '';

$_SESSION['quartos_total_dia'] = $quartos_total_dia;
$_SESSION['quartos_total_mes'] = $quartos_total_mes;
$_SESSION['quartos_bloqueados_dia'] = $quartos_bloqueados_dia;
$_SESSION['quartos_bloqueados_mes'] = $quartos_bloqueados_mes;
$_SESSION['quartos_ocupados_dia'] = $quartos_ocupados_dia;
$_SESSION['quartos_ocupados_mes'] = $quartos_ocupados_mes;
$_SESSION['quartos_cortesia_dia'] = $quartos_cortesia_dia;
$_SESSION['quartos_cortesia_mes'] = $quartos_cortesia_mes;
$_SESSION['quartos_houseuse_dia'] = $quartos_houseuse_dia;
$_SESSION['quartos_houseuse_mes'] = $quartos_houseuse_mes;

$_SESSION['adultos_dia'] = intval($pax_dia[0]);
$_SESSION['adultos_mes'] = intval($pax_mes[0]);
$_SESSION['criancas_dia'] = intval($pax_dia[1]) + intval($pax_dia[2]);
$_SESSION['criancas_mes'] = intval($pax_mes[1]) + intval($pax_mes[2]);

$_SESSION['noshow_dia'] = $noshow_dia;
$_SESSION['noshow_mes'] = $noshow_mes;
$_SESSION['forecast_1'] = $forecast_1;
$_SESSION['forecast_2'] = $forecast_2;
$_SESSION['forecast_3'] = $forecast_3;

$_SESSION['forecast_pax_1'] = '';
$_SESSION['forecast_pax_2'] = '';
$_SESSION['forecast_pax_3'] = '';
$_SESSION['forecast_pax_1'] = '';
$_SESSION['forecast_dm_2'] = '';
$_SESSION['forecast_dm_3'] = '';
