...
$receita_aeb = explode(';', $linhas_gerenciais[30]);
$receita_eventos = explode(';', $linhas_gerenciais[31]);
$receita_diversos = explode(';', $linhas_gerenciais[32]);
$receita_total = explode(';', $linhas_gerenciais[33]);
