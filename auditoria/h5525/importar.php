...
<body>
    <div class="container">
        ...
        <tr><td><label><input type="checkbox" name="ratecheck" value="ratecheck" checked><b>Conferencia de Diárias</b></label></td></tr>
        <tr><td colspan="1"></td></tr>
        <tr><td><label><input type="checkbox" name="creditlimit" value="creditlimit" checked><b>Saldo Elevado</b></label></td></tr>
        <tr><td colspan="1"></td></tr>
        <tr><td><label><input type="checkbox" name="freestay" value="freestay" checked><b>Free Stay</b></label></td></tr>
        <tr><td colspan="1"></td></tr>
        <tr><td><label><input type="checkbox" name="presentlist" value="presentlist" checked><b>Controle du Bac + Controle Garantias</b></label></td></tr>
        <tr><td style="background-color: black" colspan="1"></td></tr>
        </table>
        <br><br>
