...
$sales_dinheiro_dia = number_format($sales_dinheiro_dia * (-1), 2, ",", ".");
...
$sales_cartao_dia = number_format($sales_cartao_dia * (-1), 2, ",", ".");
...
$sales_outros_pgto_dia = number_format($sales_outros_pgto_dia * (-1), 2, ",", ".");
...
$sales_total_pgto_dia = number_format($sales_total_pgto_dia * (-1), 2, ",", ".");
...
$activeWorksheet->setCellValue('C18', 'Gerencial');
$activeWorksheet->mergeCells('C18:F18');
$activeWorksheet->setCellValue('H18', 'Trial Balance');
...
$activeWorksheet->setCellValue('K19', 'Linha');
$activeWorksheet->mergeCells('K19:L19');
$activeWorksheet->setCellValue('M19', 'Dia');
...
$activeWorksheet->setCellValue('K20', 'Pagamento Dinheiro');
$activeWorksheet->mergeCells('K20:L20');
$activeWorksheet->setCellValue('M20', 'R$'.$sales_dinheiro_dia);
$activeWorksheet->mergeCells('M20:N20');
...
$activeWorksheet->setCellValue('K21', 'Pagamento Cartão');
$activeWorksheet->mergeCells('K21:L21');
$activeWorksheet->setCellValue('M21', 'R$'.$sales_cartao_dia);
$activeWorksheet->mergeCells('M21:N21');
$activeWorksheet->setCellValue('C22', 'Receita Diversos');
$activeWorksheet->setCellValue('D22', 'R$'.number_format(floatval(str_replace(array(',', '.'), '', $receita_diversos[1]) / 100), 2, ',', '.'));
$activeWorksheet->setCellValue('E22', 'R$'.number_format(floatval(str_replace(array(',', '.'), '', $receita_diversos[2]) / 100), 2, ',', '.'));
$activeWorksheet->setCellValue('F22', 'R$'.number_format(floatval(str_replace(array(',', '.'), '', $receita_diversos[3]) / 100), 2, ',', '.'));
$activeWorksheet->setCellValue('H22', 'Receita Diversos');
$activeWorksheet->setCellValue('I22', 'R$'.$sales_outros_dia);
$activeWorksheet->setCellValue('J22', $dif_receita_diversos_dia);
$activeWorksheet->setCellValue('K22', 'Pagamento Outros');
$activeWorksheet->mergeCells('K22:L22');
$activeWorksheet->setCellValue('M22', 'R$'.$sales_outros_pgto_dia);
$activeWorksheet->mergeCells('M22:N22');
$activeWorksheet->setCellValue('C23', 'Receita Total');
$activeWorksheet->setCellValue('D23', 'R$'.number_format(floatval(str_replace(array(',', '.'), '', $receita_total[1]) / 100), 2, ',', '.'));
$activeWorksheet->setCellValue('E23', 'R$'.number_format(floatval(str_replace(array(',', '.'), '', $receita_total[2]) / 100), 2, ',', '.'));
$activeWorksheet->setCellValue('F23', 'R$'.number_format(floatval(str_replace(array(',', '.'), '', $receita_total[3]) / 100), 2, ',', '.'));
$activeWorksheet->setCellValue('H23', 'Receita Total');
$activeWorksheet->setCellValue('I23', 'R$'.$sales_total_dia);
$activeWorksheet->setCellValue('J23', $dif_receita_total_dia);
$activeWorksheet->setCellValue('K23', 'Pagamento Total');
$activeWorksheet->mergeCells('K23:L23');
$activeWorksheet->setCellValue('M23', 'R$'.$sales_total_pgto_dia);
$activeWorksheet->mergeCells('M23:N23');
...
$spreadsheet->getActiveSheet()->getStyle('C18:F18')->applyFromArray($styleArray_laranja);
...
$spreadsheet->getActiveSheet()->getStyle('H28:J28')->applyFromArray($styleArray_branco5);

$spreadsheet->getActiveSheet()->getStyle('C29:F29')->applyFromArray($styleArray_preto);
$spreadsheet->getActiveSheet()->getStyle('H29:J29')->applyFromArray($styleArray_preto);

$spreadsheet->getActiveSheet()->getStyle('J20:J23')->applyFromArray($styleArray_verde);
...
$activeWorksheet->getStyle('C19:F23')->applyFromArray($styleArray_inside_borders);
$activeWorksheet->getStyle('H18:N23')->applyFromArray($styleArray_inside_borders);
...
$activeWorksheet->getStyle('C18:F23')->applyFromArray($styleArray_outside_borders);
$activeWorksheet->getStyle('H18:N23')->applyFromArray($styleArray_outside_borders);
